...
Cursor implemented Google OAuth and Gmail send on `cursor/implementation-checkpoint` (PR #4). This file remains the account-holder setup checklist. Google client credentials, consent, and any live send are still pending. Keep DRY_RUN=true.
